...
/**
 * Phaser EventEmitter with compile-time type safety for all GameEvent payloads.
 *
 * Use the `typed*` methods instead of the bare Phaser `on` / `once` / `emit` / `off`
 * to get payload type-checking on both the emitter and listener sides.
 */
